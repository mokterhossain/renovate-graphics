...
const services: Service[] = [
  ...
  /* {
    ...
    description:
        "Transform your wedding photos into timeless, romantic memories. Our team carefully enhances each image with professional color correction, subtle retouching, and background improvements — fast and affordably.",
  ...
  price: "$6 per photo",
  description:
    "Make your jewelry photos sparkle and capture every detail beautifully. Our experts enhance gemstones, smooth metal surfaces, adjust colors, and remove unwanted objects to create flawless, high-quality images perfect for catalogs, eCommerce, or advertising.",
  ...
  price: "$30 per image",
  description:
    "Turn ordinary photos into imaginative, eye-catching creations. Our team can transform backgrounds, swap faces, adjust expressions, create artistic renditions, or design fun collages — perfect for personal projects, marketing, or social media.",
...
}, */
{
  ...
  description:
    "Showcase properties in their best light and help clients imagine their dream homes. Our experts enhance real estate and interior photos with professional edits that highlight every detail and keep your listings visually appealing and market-ready.",
...
},
{
  ...
  price: "$5 per photo",
  description:
    "Bring your images to the next level with cutting-edge AI-powered enhancements. Our advanced algorithms and expert touch improve clarity, colors, and details, transforming ordinary photos into professional-quality visuals for personal, commercial, or marketing use.",
